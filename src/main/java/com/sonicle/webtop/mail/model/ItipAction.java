...
/**
 * Caller-supplied verb for {@code MailManager.applyICalendar}. Cross-product
 * with the incoming iTIP METHOD picks the actual server effect — see the
 * behavior matrix on the method's javadoc.
 */
